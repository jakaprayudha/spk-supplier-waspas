...
<html lang="en">
    ...
    <body class="bg-gradient-warning">
		<nav class="navbar navbar-expand-lg navbar-dark bg-white shadow-lg pb-3 pt-3 font-weight-bold">
            <div class="container">
                <a class="navbar-brand text-warning" style="font-weight: 900;" href="login.php"> <i class="fa fa-database mr-2 rotate-n-15"></i> Sistem Pendukung Keputusan Metode WASPAS</a>
            </div>
        </nav>
				...
				<div class="col-xl-6 col-lg-6 col-md-6 mt-5">
                    <div class="card bg-none o-hidden border-0 my-5 text-white" style="background: none;">
                        <div class="text-justify card-body p-0">
                            <h4 style="font-weight: 800;">Sistem Pendukung Keputusan Metode WASPAS</h4>
                            <p class="pt-4">
                            ...
                            <p>
                                Metode Weight Aggregated Sum Product Assesment (WASPAS) merupakan metode yang dapat mengurangi kesalahan atau mengoptimalkan dalam penaksiran untuk pemilihan nilai tertinggi dan terendah. Metode ini merupakan kombinasi unik dari pendekatan MCDM yaitu Weight Sum Model (WSM) dan Weight Product Model (WPM).
                            </p>
                        </div>
                    </div>
                </div>
